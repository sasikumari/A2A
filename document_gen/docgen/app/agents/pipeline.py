...
from app.content_fallbacks import fallback_table_data
from app.document_validator import repair_sections_for_validation, validate_generated_document
from app.document_guides import build_blueprint_plan, get_document_blueprint
from app.models import DocumentPlan, GeneratedContent
from app.plan_store import save_json_artifact
from app.rag.engine import retrieve_multi_query
...
def retrieve_context(state: dict) -> dict:
    ...
    try:
        ...
        if ref_path and Path(ref_path).exists():
            from app.rag.engine import extract_reference_structure
...
def _generate_single_diagram(llm: ChatOllama, spec: dict, output_dir: str) -> tuple[str, str]:
    ...
    """
    from app.tools.diagram_generator import generate_plantuml_diagram, _find_plantuml_jar
